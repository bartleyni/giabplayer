...
class VLCClient(object):
	...
	#NJB Custom Functions

    def loopon(self):
        """Turn on Loop playlist"""
        return self._send_command("loop on")
		
    def loopoff(self):
        """Turn off Loop playlist"""
        return self._send_command("loop off")

    def randomon(self):
        """Turn on Random playlist"""
        return self._send_command("random on")
		
    def randomoff(self):
        """Turn off Random playlist"""
        return self._send_command("random off")
